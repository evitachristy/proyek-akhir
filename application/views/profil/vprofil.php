...
<div class="container">
	...
	<div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form action="<?php echo base_url();?>cmember/simpanprofil" method="post" class="form-horizontal" role="form">
          <div class="form-group">
            <label class="col-lg-3 control-label">Nama:</label>
            <div class="col-lg-8">
              <input class="form-control" name="nama" type="text" value="<?php echo $valuser->nama; ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Email:</label>
            <div class="col-lg-8">
              <input class="form-control" name="email" type="text"  value="<?php echo $valuser->email;?>">
            </div>
          </div>
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" type="text" name="notelp" value="<?php echo $valuser->notelp; ?>">
            </div>
          </div>
          <div class="form-group">
