...
<div class="container">
	<div class="row">
        ...
        <form class="form-horizontal" action="<?php echo base_url() ?>index.php/home/daftarPemilik" method="post" enctype="multipart/form-data">
<fieldset>
...
<!-- Text input-->
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
		  <input type="text" name="username" placeholder="Masukan Username" class="form-control" value="<?php echo set_value('username'); ?>" >
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
		  <input type="text" name="ktp" placeholder="Masukan KTP" class="form-control" value="<?php echo set_value('ktp'); ?>" >
		  </div>
		</div>
